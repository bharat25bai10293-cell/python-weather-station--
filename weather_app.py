...
# --- 1. Define Constants (Good Practice) ---
# Replace this with your actual, active key when it's ready!
...
def get_weather(city_name):
    ...
    # URL Encoding: Ensuring the city name is safe for the web URL
...
# --- 2. The Main Execution Block (Best Practice) ---
...
if __name__ == "__main__":
    ...
    # Clean the input, removing quotes and spaces
